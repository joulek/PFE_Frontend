...
function TabBtn({ active, onClick, children, icon: Icon }) {
  return (
    <button type="button" onClick={onClick}
      className={`flex items-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-xl transition-all ${active ? "bg-[#4E8F2F] text-white shadow-sm" : "text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-400"
        }`}>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 max-h-[400px] overflow-y-auto pr-1">
            {quiz.answers.map((a, i) => (
              <div key={i} className={`rounded-xl border p-4 ${a.isCorrect
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 pt-10 pb-16">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Entretiens direction générale planifiés pour vous. {uniqueCandidates} candidat{uniqueCandidates > 1 ? "s" : ""}, {upcoming} à venir, {quizDone} avec quiz complété.
            </p>
          </div>
...
className="bg-gray-50/60 hover:bg-amber-50/40 dark:bg-gray-700/30  border-t border-gray-100 ">
                            {/* ✅ Colonne # supprimée */}
