      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 transition-colors">
            Veuillez vérifier les informations ci-dessous et confirmer votre présence.
          </p>
        </div>
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors">
                      Validez votre présence pour cette date et cet horaire.
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors">
                      Proposez un nouveau créneau qui vous convient mieux.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-white transition-colors">
                    {action === "confirm" ? "Confirmer l'entretien" : "Modifier votre entretien"}
                  </h2>
                  <p className="text-gray-600 dark:text-gray-300 transition-colors">
                    {action === "confirm" 
                      ? "Validez les informations ci-dessous" 
                      : "Proposez un nouveau créneau qui correspond mieux à votre emploi du temps."}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-gray-900 dark:text-white mb-1 transition-colors">
                      Entretien technique - {interview.jobTitle}
                    </h3>
                    ...
                    {action === "confirm" ? (
                      ...
                      <>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          Seules les dates de la semaine prochaine sont disponibles
                        </p>
                      </>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {action === "confirm" ? (
                      ...
                      >
                        ...
                        <option value="14:00">14:00 - 15:00 (Après-midi)</option>
                        <option value="15:00">15:00 - 16:00 (Après-midi)</option>
                        <option value="16:00">16:00 - 17:00 (Après-midi)</option>
                      </select>
                    )}
                  </div>
                </div>
              ...
              {action === "modify" && (
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    placeholder="Ex: Un imprévu professionnel m'empêche d'être disponible le 24..."
