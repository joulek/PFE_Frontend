...
<div className="px-10 py-8">
  <div className="flex flex-col gap-6">
    ...
    <div className="flex items-start gap-6">
      {/* Warning icon */}
      <div className="h-14 w-14 rounded-full bg-red-50 grid place-items-center shrink-0">
        <svg
          width="26"
          height="26"
          viewBox="0 0 24 24"
      ...
      <div>
        ...
        <p className="text-gray-900 font-extrabold text-xl mt-2">
          {job?.titre}
        </p>
      </div>
    </div>
    ...
    <div className="flex justify-end gap-4 pt-4">
      <button
        type="button"
        onClick={onClose}
        className="h-12 px-8 rounded-full border border-gray-200
